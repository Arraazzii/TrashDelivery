        ...
        <ul class="side-nav fixed col s2 m2 l2" style="padding:0;margin:0;width:225px;">
            <li>
                <div class="userView">
                    ...
                    <a href=""><span style="margin-left:35px" class="white-text email">Kurir: <?php echo $_SESSION['kode_kurir']; ?></span></a>
                </div>
            </li>
            ...
            <li><a class="waves-effect" href="pesanan"><i class="material-icons">group_add</i>Pesanan</a></li>
        </ul>
    </div>
</header>
<main>