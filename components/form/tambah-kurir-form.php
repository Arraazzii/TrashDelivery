<form class="col s12" action="../controllers/config/p_tambah-kurir.php" method="post">
    <div class="form-container">
        <div class="row">
            <div class="input-field col s6">
                <input id="name" type="text" name="nama" class="validate" required>
                <label for="name">Nama</label>
            </div>
            <div class="input-field col s6">
                <input id="gaji" type="number" name="gaji" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="18" class="validate" required>
