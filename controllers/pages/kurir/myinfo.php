...
<div class="col s12 m12 l12">
    <div id="profile-page-header" class="card">
        ...
        <div class="card-content hide-on-small-only">
            <div class="row" style="margin-top:20px">
                <div class="col s3 offset-s2">
                    <h4 class="card-title grey-text text-darken-4"><?php echo $d['nama_kurir']; ?></h4>
                ...
                <div class="col s2 offset-s4 push-s1">
                    <h4 class="card-title grey-text text-darken-4"><?php echo $_SESSION['kode_kurir'];?></h4>
                    <p class="medium-small grey-text">Kode Saya</p>
                </div>
        ...
        <div class="card-reveal" style="display: none; transform: translateY(0px);">
            <p class="row">
                <span class="card-title grey-text text-darken-4 left"><i class="material-icons teal-text">person</i><?php echo $_SESSION['kode_kurir']; ?></span>
                <span class="card-title grey-text text-darken-4 right"><i class="material-icons right">close</i></span>
            </p>
            <div class="divider"></div>
            <?php include'../../../components/form/edit-kurir-profil-form.php'; ?>
        </div>
        <?php }
        }
    ?>
